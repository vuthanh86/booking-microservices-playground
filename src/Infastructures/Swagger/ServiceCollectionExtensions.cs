        ...
        Assembly assembly, string swaggerSectionName = "SwaggerOptions")
    {
        ...
        services.AddSwaggerGen(
                               options =>
                               {
                                   ...
                                   string xmlFile = XmlCommentsFilePath(assembly);
                              ...
                              \r\n\r\nExample: 'Bearer 12345abcdef'",
                                   ...
                                   options.AddSecurityDefinition(HeaderName,
                                                                 ...
                                                                 {
                                                                     Description
                                                                         = "Api key needed to access the endpoints. X-Api-Key: My_API_Key",
                                                                     In = ParameterLocation.Header,
                                                                     Name = HeaderName,
                                                                     Type = SecuritySchemeType.ApiKey
                                                                 });
                                   ...
                                   options.TagActionsBy(api =>
                                   {
                                       ...
                                       if (api.ActionDescriptor is ControllerActionDescriptor
